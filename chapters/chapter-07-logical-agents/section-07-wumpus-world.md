...
**Wumpus World** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Wumpus World** using agent-centered language.
...
1. Build the smallest possible instance of **Wumpus World**.
2. Solve it by hand.
...
1. What is the representation used by **Wumpus World**?
...
**Previous:** [Section 07.6: Backward Chaining](./section-06-backward-chaining.md)  
**Next:** [Section 7.8: Logic Limitations Preview](./section-08-logic-limitations-preview.md)
