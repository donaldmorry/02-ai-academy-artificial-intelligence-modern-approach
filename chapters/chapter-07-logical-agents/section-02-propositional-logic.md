# Section 07.2: Propositional Logic
...
**Propositional Logic** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Propositional Logic** using agent-centered language.
...
1. Build the smallest possible instance of **Propositional Logic**.
2. Solve it by hand.
...
1. What is the representation used by **Propositional Logic**?
...
**Previous:** [Section 07.1: Knowledge-Based Agents](./section-01-knowledge-based-agents.md)  
**Next:** [Section 7.3: Inference and Entailment](./section-03-inference-and-entailment.md)
