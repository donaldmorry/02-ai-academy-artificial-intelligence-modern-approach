...
**Mechanism Design** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Mechanism Design** using agent-centered language.
...
1. Build the smallest possible instance of **Mechanism Design**.
2. Solve it by hand.
...
1. What is the representation used by **Mechanism Design**?
...
**Previous:** [Section 18.5: Cooperative Games](./section-05-cooperative-games.md)  
**Next:** [Section 18.7: Voting and Social Choice](./section-07-voting-and-social-choice.md)
