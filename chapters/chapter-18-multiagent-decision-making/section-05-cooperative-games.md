# Section 18.5: Cooperative Games
...
**Cooperative Games** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Cooperative Games** using agent-centered language.
...
1. Build the smallest possible instance of **Cooperative Games**.
2. Solve it by hand.
...
1. What is the representation used by **Cooperative Games**?
...
**Previous:** [Section 18.4: Extensive-Form Games](./section-04-extensive-form-games.md)  
**Next:** [Section 18.6: Mechanism Design](./section-06-mechanism-design.md)
