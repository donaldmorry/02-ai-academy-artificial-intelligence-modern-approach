# Section 18.4: Extensive-Form Games
...
**Extensive-Form Games** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Extensive-Form Games** using agent-centered language.
...
1. Build the smallest possible instance of **Extensive-Form Games**.
2. Solve it by hand.
...
1. What is the representation used by **Extensive-Form Games**?
...
**Previous:** [Section 18.3: Iterated and Repeated Games](./section-03-iterated-and-repeated-games.md)  
**Next:** [Section 18.5: Cooperative Games](./section-05-cooperative-games.md)
