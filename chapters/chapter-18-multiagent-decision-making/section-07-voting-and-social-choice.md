# Section 18.7: Voting and Social Choice
...
**Voting and Social Choice** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Voting and Social Choice** using agent-centered language.
...
1. Build the smallest possible instance of **Voting and Social Choice**.
2. Solve it by hand.
...
1. What is the representation used by **Voting and Social Choice**?
...
**Previous:** [Section 18.6: Mechanism Design](./section-06-mechanism-design.md)
