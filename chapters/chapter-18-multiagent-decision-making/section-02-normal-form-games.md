# Section 18.2: Normal-Form Games
...
**Normal-Form Games** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Normal-Form Games** using agent-centered language.
...
1. Build the smallest possible instance of **Normal-Form Games**.
2. Solve it by hand.
...
1. What is the representation used by **Normal-Form Games**?
...
**Previous:** [Section 18.1: Multiagent Environments](./section-01-multiagent-environments.md)  
**Next:** [Section 18.3: Iterated and Repeated Games](./section-03-iterated-and-repeated-games.md)
