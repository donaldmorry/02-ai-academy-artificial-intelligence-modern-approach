# Section 15.3: Probabilistic Programs

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 15.3
> **Previous:** [Section 15.2 - Open-Universe Models](./section-02-open-universe-models.md)
> **Next:** [Section 15.4 - Inference in Programs](./section-04-inference-in-programs.md)
...
A **probabilistic program** is code with **random choices** defining a generative model.

---

## Observe and Condition

`observe` / `condition` clamps variables to data; posterior over remaining random variables is target.

---

## Church and WebPPL Concepts

Functional PPLs: random procedures, conditioning, query.

---

## Separation of Model and Inference

Same program can run MCMC, VI, or enumeration - inference engine is pluggable.

---

## Minimal Program Pattern

```python
# generative story
theta = sample('theta', Uniform(0, 1))
for i in range(N):
    observe('x', Bernoulli(theta), data[i])
```
Conditioning on `data` yields posterior over `theta`.

---

## Key Takeaways

1. Programs specify generative processes compactly.
2. Conditioning expresses learning from data.
3. Inference algorithms in [Section 15.4](./section-04-inference-in-programs.md).
...
**Focus:** Probabilistic Programs. Read the section before the linked sections below.
...
- Prior: [Section 15.2](./section-02-open-universe-models.md)
- Next: [Section 15.4](./section-04-inference-in-programs.md)
...
- **Random** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **choices** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **conditioning** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **observe** - see [../../GLOSSARY.md](../../GLOSSARY.md)

---

## Reflection Questions

1. What is the central idea of Probabilistic Programs in AIMA?
2. How does Probabilistic Programs relate to Random choices, conditioning, observe?
3. Give a concrete application of Probabilistic Programs.
4. What assumptions does the textbook emphasize for Probabilistic Programs?
5. When would an alternative to Probabilistic Programs be preferable?
6. How would you verify understanding of Probabilistic Programs in code?

---

**Previous:** [Section 15.2 - Open-Universe Models](./section-02-open-universe-models.md) · **Next:** [Section 15.4 - Inference in Programs](./section-04-inference-in-programs.md)
