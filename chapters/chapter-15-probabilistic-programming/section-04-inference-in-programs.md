# Section 15.4: Inference in Programs

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 15.4
> **Previous:** [Section 15.3 - Probabilistic Programs](./section-03-probabilistic-programs.md)
> **Next:** [Section 15.5 - Stan and Pyro Overview](./section-05-stan-and-pyro-overview.md)
...
Metropolis-Hastings proposes changes to execution traces; accept/reject by likelihood ratio.

---

## HMC

**Hamiltonian Monte Carlo** uses gradients for efficient continuous proposals - Stan default.

---

## Variational Inference

Optimize simpler distribution to approximate posterior - scalable for deep generative models.
...
| Method | Best for |
|--------|----------|
| Gibbs | Discrete local structure |
| HMC | Continuous differentiable models |
| VI | Large data, speed |

---

## Trace-Based Inference

MCMC operates on program **execution traces** - complete assignments to all random choices.
Proposals modify subsets of choices; acceptance corrects for asymmetric proposals.

---

## Key Takeaways

1. PPL inference reuses general MCMC/VI machinery.
2. HMC excels in continuous parameter spaces.
3. VI trades bias for speed.
...
**Focus:** Inference in Probabilistic Programs. Read the section before the linked sections below.
...
- Prior: [Section 15.3](./section-03-probabilistic-programs.md)
- Next: [Section 15.5](./section-05-stan-and-pyro-overview.md)
...
- **HMC** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **variational** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **inference** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **in** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **PPLs** - see [../../GLOSSARY.md](../../GLOSSARY.md)

---

## Reflection Questions

1. What is the central idea of Inference in Programs in AIMA?
2. How does Inference in Programs relate to MCMC, HMC, variational inference in PPLs?
3. Give a concrete application of Inference in Programs.
4. What assumptions does the textbook emphasize for Inference in Programs?
5. When would an alternative to Inference in Programs be preferable?
6. How would you verify understanding of Inference in Programs in code?

---

**Previous:** [Section 15.3 - Probabilistic Programs](./section-03-probabilistic-programs.md) · **Next:** [Section 15.5 - Stan and Pyro Overview](./section-05-stan-and-pyro-overview.md)
