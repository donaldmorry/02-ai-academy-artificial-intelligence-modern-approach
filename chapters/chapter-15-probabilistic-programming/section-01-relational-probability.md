# Section 15.1: Relational Probability

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 15.1
> **Previous:** [Chapter 14 - Probabilistic Reasoning over Time](../chapter-14-probabilistic-reasoning-time/README.md)
> **Next:** [Section 15.2 - Open-Universe Models](./section-02-open-universe-models.md)
> **Prerequisites:** [Chapter 14 - Probabilistic Reasoning over Time](../chapter-14-probabilistic-reasoning-time/README.md)
...
Standard BNs use fixed variable sets; **relational** models reason about **objects** and **relations**.
Connects to [Chapter 08](../chapter-08-first-order-logic/README.md) FOL syntax with probability.

---

## Objects and Relations

Example: `Friends(x,y)`, `Smokes(x)` - template for many individuals.

---

## Identity Uncertainty

Which observation refers to which object? Common in data association and tracking.

---

## Relational Probability Models

**RPMs** / **plate models** tie parameters across object tuples.

---

## Example: Social Network

Objects: users; relation: `Friends(a,b)`; attribute: `Smokes(a)`.
Single CPT template applies to every user pair - parameter sharing scales to large populations.

---

## Key Takeaways

1. Real domains have varying object counts.
2. Relational structure shares parameters across instances.
3. Open-universe in [Section 15.2](./section-02-open-universe-models.md).
...
**Focus:** Relational Probability. Read the section before the linked sections below.
...
- Prior: [Chapter 14](../chapter-14-probabilistic-reasoning-time/README.md)
- Next: [Section 15.2](./section-02-open-universe-models.md)
- Related: [Chapter 08](../chapter-08-first-order-logic/README.md)
...
- **Objects** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **relations** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **identity** - see [../../GLOSSARY.md](../../GLOSSARY.md)
...
1. What is the central idea of Relational Probability in AIMA?
2. How does Relational Probability relate to Objects, relations, identity uncertainty?
3. Give a concrete application of Relational Probability.
4. What assumptions does the textbook emphasize for Relational Probability?
5. When would an alternative to Relational Probability be preferable?
6. How would you verify understanding of Relational Probability in code?

---

**Previous:** [Chapter 14 - Probabilistic Reasoning over Time](../chapter-14-probabilistic-reasoning-time/README.md) · **Next:** [Section 15.2 - Open-Universe Models](./section-02-open-universe-models.md)
