# Section 19.5: Support Vector Machines
...
**Support Vector Machines** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Support Vector Machines** using agent-centered language.
...
1. Build the smallest possible instance of **Support Vector Machines**.
2. Solve it by hand.
...
1. What is the representation used by **Support Vector Machines**?
...
**Previous:** [Section 19.4: Nonparametric Models](./section-04-nonparametric-models.md)  
**Next:** [Section 19.6: Ensemble Learning](./section-06-ensemble-learning.md)
