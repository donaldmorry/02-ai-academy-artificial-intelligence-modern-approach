# Section 19.6: Ensemble Learning
...
**Ensemble Learning** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Ensemble Learning** using agent-centered language.
...
1. Build the smallest possible instance of **Ensemble Learning**.
2. Solve it by hand.
...
1. What is the representation used by **Ensemble Learning**?
...
**Previous:** [Section 19.5: Support Vector Machines](./section-05-support-vector-machines.md)  
**Next:** [Section 19.7: Learning Theory](./section-07-learning-theory.md)
