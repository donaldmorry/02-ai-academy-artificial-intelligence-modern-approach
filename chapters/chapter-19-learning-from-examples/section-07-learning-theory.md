...
**Learning Theory** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Learning Theory** using agent-centered language.
...
1. Build the smallest possible instance of **Learning Theory**.
2. Solve it by hand.
...
1. What is the representation used by **Learning Theory**?
...
**Previous:** [Section 19.6: Ensemble Learning](./section-06-ensemble-learning.md)  
**Next:** [Section 19.8: Model Selection](./section-08-model-selection.md)
