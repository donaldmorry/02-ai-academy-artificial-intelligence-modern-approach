# Section 27.4: Fairness and Justice

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 27.4
> **Previous:** [Section 27.3 - Ethics and AI](./section-03-ethics-and-ai.md)
> **Next:** [Section 27.5 - Transparency](./section-05-transparency.md)
...
**Fairness and Justice** examines limits, values, and responsibilities as AI systems gain capability and societal influence.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **Fairness and Justice**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Walk through a toy instance of **Fairness and Justice** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **fairness and justice** and measure impact on your chosen metric.
...
Use **Fairness and Justice** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Fairness and Justice**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **disparate impact** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **equalized odds** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **fairness** - see [../../GLOSSARY.md](../../GLOSSARY.md)
...
6. How does fairness and justice support rational agency?

---

**Previous:** [Section 27.3 - Ethics and AI](./section-03-ethics-and-ai.md) · **Next:** [Section 27.5 - Transparency](./section-05-transparency.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 27.4
