# Section 27.6: Privacy and Surveillance

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 27.6
> **Previous:** [Section 27.5 - Transparency](./section-05-transparency.md)
> **Next:** [Section 27.7 - AI Safety](./section-07-ai-safety.md)
...
**Privacy and Surveillance** examines limits, values, and responsibilities as AI systems gain capability and societal influence.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **Privacy and Surveillance**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Walk through a toy instance of **Privacy and Surveillance** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **privacy and surveillance** and measure impact on your chosen metric.
...
Use **Privacy and Surveillance** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Privacy and Surveillance**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **GDPR** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **federated learning** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **privacy** - see [../../GLOSSARY.md](../../GLOSSARY.md)
...
6. How does privacy and surveillance support rational agency?

---

**Previous:** [Section 27.5 - Transparency](./section-05-transparency.md) · **Next:** [Section 27.7 - AI Safety](./section-07-ai-safety.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 27.6
