# Section 27.1: Philosophical Foundations

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 27.1
> **Previous:** [Chapter 26 - Robotics](../chapter-26-robotics/README.md)
> **Next:** [Section 27.2 - Consciousness and Qualia](./section-02-consciousness-and-qualia.md)
> **Prerequisites:** [Chapter 01 - Introduction](../chapter-01-introduction/README.md)
...
**Philosophical Foundations** examines limits, values, and responsibilities as AI systems gain capability and societal influence.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **Philosophical Foundations**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Walk through a toy instance of **Philosophical Foundations** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **philosophical foundations** and measure impact on your chosen metric.
...
Use **Philosophical Foundations** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Philosophical Foundations**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **Chinese Room** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **Turing test** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **strong AI** - see [../../GLOSSARY.md](../../GLOSSARY.md)
...
6. How does philosophical foundations support rational agency?

---

**Previous:** [Chapter 26 - Robotics](../chapter-26-robotics/README.md) · **Next:** [Section 27.2 - Consciousness and Qualia](./section-02-consciousness-and-qualia.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 27.1
