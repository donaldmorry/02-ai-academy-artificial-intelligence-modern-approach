# Section 26.4: Localization

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 26.4
> **Previous:** [Section 26.3 - Perception for Robots](./section-03-perception-for-robots.md)
> **Next:** [Section 26.5 - Mapping and SLAM](./section-05-mapping-and-slam.md)
...
Russell and Norvig integrate **localization** into embodied agents that perceive, plan, and act in physical environments.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **Localization**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Robots operating in the real world require reliable Monte Carlo and Kalman localization. This section formalizes models and algorithms from Chapter 26.4.
...
$$
P(\mathbf{x}_t \mid \mathbf{z}_{1:t}) \propto P(\mathbf{z}_t \mid \mathbf{x}_t) \int P(\mathbf{x}_t \mid \mathbf{x}_{t-1}, u_t) P(\mathbf{x}_{t-1} \mid \mathbf{z}_{1:t-1}) d\mathbf{x}_{t-1}
$$
> **Readable form:** Bayes filter updates pose belief from odometry and sensors.
...
| Component | Role in Localization |
|-----------|----------------|
| State | Configuration |
...
Walk through a toy instance of **Localization** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **localization** and measure impact on your chosen metric.
...
Use **Localization** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Localization**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **odometry** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **Kalman filter** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **Monte Carlo localization** - see [../../GLOSSARY.md](../../GLOSSARY.md)

---

## Reflection Questions

1. What is the role of Monte Carlo and Kalman localization in a mobile manipulator?
...
6. How does localization support rational agency?

---

**Previous:** [Section 26.3 - Perception for Robots](./section-03-perception-for-robots.md) · **Next:** [Section 26.5 - Mapping and SLAM](./section-05-mapping-and-slam.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 26.4
