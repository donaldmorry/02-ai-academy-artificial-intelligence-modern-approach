# Section 26.8: Human-Robot Interaction

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 26.8
> **Previous:** [Section 26.7 - Control](./section-07-control.md)
...
Robots operating in the real world require reliable shared autonomy and safety. This section formalizes models and algorithms from Chapter 26.8.
...
$$
U = \alpha U_{\text{human}} + (1-\alpha) U_{\text{robot}}
$$
> **Readable form:** Blended utility for shared control.

---

```python
def should_ask_for_confirmation(intent_prob, risk_level):
    threshold = 0.90 if risk_level == "high" else 0.70
    return intent_prob < threshold
```
---

## Summary

| Component | Role in Human-Robot Interaction |
|-----------|----------------|
| State | Configuration |
...
Walk through a toy instance of **Human-Robot Interaction** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **human-robot interaction** and measure impact on your chosen metric.
...
Use **Human-Robot Interaction** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Human-Robot Interaction**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **shared autonomy** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **HRI** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **safety** - see [../../GLOSSARY.md](../../GLOSSARY.md)

---

## Reflection Questions

1. What is the role of shared autonomy and safety in a mobile manipulator?
...
6. How does human-robot interaction support rational agency?
...
1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 26.8
