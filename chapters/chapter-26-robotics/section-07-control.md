# Section 26.7: Control

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 26.7
> **Previous:** [Section 26.6 - Motion Planning](./section-06-motion-planning.md)
> **Next:** [Section 26.8 - Human-Robot Interaction](./section-08-human-robot-interaction.md)
...
Russell and Norvig integrate **control** into embodied agents that perceive, plan, and act in physical environments.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **Control**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Robots operating in the real world require reliable PID and trajectory tracking. This section formalizes models and algorithms from Chapter 26.7.
...
$$
> **Readable form:** PID combines present, accumulated, and rate of error.
...
Walk through a toy instance of **Control** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **control** and measure impact on your chosen metric.
...
Use **Control** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Control**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **PID** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **trajectory tracking** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **MPC** - see [../../GLOSSARY.md](../../GLOSSARY.md)

---

## Reflection Questions

1. What is the role of PID and trajectory tracking in a mobile manipulator?
...
6. How does control support rational agency?

---

**Previous:** [Section 26.6 - Motion Planning](./section-06-motion-planning.md) · **Next:** [Section 26.8 - Human-Robot Interaction](./section-08-human-robot-interaction.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 26.7
