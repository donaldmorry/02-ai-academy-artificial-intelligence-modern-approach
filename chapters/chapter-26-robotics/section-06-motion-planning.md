# Section 26.6: Motion Planning

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 26.6
> **Previous:** [Section 26.5 - Mapping and SLAM](./section-05-mapping-and-slam.md)
> **Next:** [Section 26.7 - Control](./section-07-control.md)
...
Russell and Norvig integrate **motion planning** into embodied agents that perceive, plan, and act in physical environments.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **Motion Planning**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Robots operating in the real world require reliable configuration space, RRT, PRM. This section formalizes models and algorithms from Chapter 26.6.
...
$$
\pi^* = \arg\min_{\pi} \sum_t c(\mathbf{x}_t, \mathbf{u}_t)
$$
> **Readable form:** Optimal plan minimizes cumulative cost in C-space.
...
def steer(q_near, q_rand, step):
    ...
    return (q_near[0] + step * dx / norm, q_near[1] + step * dy / norm)
```
---

## Summary

| Component | Role in Motion Planning |
|-----------|----------------|
| State | Configuration |
...
Walk through a toy instance of **Motion Planning** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **motion planning** and measure impact on your chosen metric.
...
Use **Motion Planning** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Motion Planning**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **configuration space** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **RRT** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **PRM** - see [../../GLOSSARY.md](../../GLOSSARY.md)

---

## Reflection Questions

1. What is the role of configuration space, RRT, PRM in a mobile manipulator?
...
6. How does motion planning support rational agency?

---

**Previous:** [Section 26.5 - Mapping and SLAM](./section-05-mapping-and-slam.md) · **Next:** [Section 26.7 - Control](./section-07-control.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 26.6
