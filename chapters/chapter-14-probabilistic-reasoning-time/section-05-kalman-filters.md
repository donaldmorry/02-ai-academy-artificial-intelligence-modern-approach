# Section 14.5: Kalman Filters

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 14.4.2
> **Previous:** [Section 14.4 - Dynamic Bayesian Networks](./section-04-dynamic-bayesian-networks.md)
> **Next:** [Section 14.6 - Particle Filtering](./section-06-particle-filtering.md)
...
State and observations continuous; dynamics and sensors are linear with Gaussian noise.
$$
X_t = A X_{t-1} + B u_t + \epsilon_t, \quad E_t = C X_t + \delta_t
$$
> **Readable form:** Linear transform plus Gaussian noise at each step.

---

## Kalman Filter Updates

**Predict**: $\hat{x}_{t|t-1} = A\hat{x}_{t-1}$, $P_{t|t-1} = AP_{t-1}A^T + Q$.
**Update**: Kalman gain $K$ combines prediction with observation.

---

## Optimality

For linear Gaussian models, Kalman filter gives exact $P(X_t \mid e_{1:t})$ - optimal mean and covariance.

---

## Extended Kalman Filter

Local linearization for mild nonlinearities - used in robotics GPS fusion.
...
1. Kalman filter handles continuous linear Gaussian tracking.
2. Predict-update cycle mirrors HMM filtering.
3. EKF extends to weak nonlinearities.
4. Particle filters when linearity fails.
...
**Focus:** Kalman Filters. Read the section before the linked sections below.
...
- Prior: [Section 14.4](./section-04-dynamic-bayesian-networks.md)
- Next: [Section 14.6](./section-06-particle-filtering.md)
...
- **Linear** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **Gaussian** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **assumptions** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **update** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **equations** - see [../../GLOSSARY.md](../../GLOSSARY.md)

---

## Reflection Questions

1. What is the central idea of Kalman Filters in AIMA?
2. How does Kalman Filters relate to Linear Gaussian assumptions, update equations?
3. Give a concrete application of Kalman Filters.
4. What assumptions does the textbook emphasize for Kalman Filters?
5. When would an alternative to Kalman Filters be preferable?
6. How would you verify understanding of Kalman Filters in code?

---

**Previous:** [Section 14.4 - Dynamic Bayesian Networks](./section-04-dynamic-bayesian-networks.md) · **Next:** [Section 14.6 - Particle Filtering](./section-06-particle-filtering.md)
