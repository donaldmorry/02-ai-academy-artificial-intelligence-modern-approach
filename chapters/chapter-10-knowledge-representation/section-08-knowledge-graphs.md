...
**Knowledge Graphs** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Knowledge Graphs** using agent-centered language.
...
1. Build the smallest possible instance of **Knowledge Graphs**.
2. Solve it by hand.
...
1. What is the representation used by **Knowledge Graphs**?
...
**Previous:** [Section 10.7: The Frame Problem](./section-07-the-frame-problem.md)
