# Section 10.4: Reasoning Systems
...
**Reasoning Systems** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Reasoning Systems** using agent-centered language.
...
1. Build the smallest possible instance of **Reasoning Systems**.
2. Solve it by hand.
...
1. What is the representation used by **Reasoning Systems**?
...
**Previous:** [Section 10.3: Mental Objects](./section-03-mental-objects.md)  
**Next:** [Section 10.5: Default Reasoning](./section-05-default-reasoning.md)
