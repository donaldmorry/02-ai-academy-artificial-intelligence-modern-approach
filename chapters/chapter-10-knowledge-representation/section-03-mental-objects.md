...
**Mental Objects** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Mental Objects** using agent-centered language.
...
1. Build the smallest possible instance of **Mental Objects**.
2. Solve it by hand.
...
1. What is the representation used by **Mental Objects**?
...
**Previous:** [Section 10.2: Events and Time](./section-02-events-and-time.md)  
**Next:** [Section 10.4: Reasoning Systems](./section-04-reasoning-systems.md)
