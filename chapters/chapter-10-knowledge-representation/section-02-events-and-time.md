...
**Events and Time** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Events and Time** using agent-centered language.
...
1. Build the smallest possible instance of **Events and Time**.
2. Solve it by hand.
...
1. What is the representation used by **Events and Time**?
...
**Previous:** [Section 10.1: Ontological Engineering](./section-01-ontological-engineering.md)  
**Next:** [Section 10.3: Mental Objects](./section-03-mental-objects.md)
