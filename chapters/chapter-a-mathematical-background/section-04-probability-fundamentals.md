# Section A.4: Probability Fundamentals

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Appendix A.4
> **Previous:** [Section A.3 - Advanced Linear Algebra](./section-03-advanced-linear-algebra.md)
> **Next:** [Section A.5 - Distributions](./section-05-distributions.md)
...
**Probability Fundamentals** provides mathematical tools referenced throughout AIMA and Courses 2-4.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **Probability Fundamentals**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Walk through a toy instance of **Probability Fundamentals** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **probability fundamentals** and measure impact on your chosen metric.
...
Use **Probability Fundamentals** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Probability Fundamentals**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **Bayes rule** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **conditional probability** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **axioms** - see [../../GLOSSARY.md](../../GLOSSARY.md)
...
6. How does probability fundamentals support rational agency?

---

**Previous:** [Section A.3 - Advanced Linear Algebra](./section-03-advanced-linear-algebra.md) · **Next:** [Section A.5 - Distributions](./section-05-distributions.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Appendix A.4
