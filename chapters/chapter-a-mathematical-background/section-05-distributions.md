...
**Distributions** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Distributions** using agent-centered language.
...
1. Build the smallest possible instance of **Distributions**.
2. Solve it by hand.
...
1. What is the representation used by **Distributions**?
...
**Previous:** [Section A.4: Probability Fundamentals](./section-04-probability-fundamentals.md)  
**Next:** [Section A.6: Expectation and Variance](./section-06-expectation-and-variance.md)
