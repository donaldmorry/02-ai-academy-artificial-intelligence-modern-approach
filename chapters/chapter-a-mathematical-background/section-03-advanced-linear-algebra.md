# Section A.3: Advanced Linear Algebra
...
**Advanced Linear Algebra** is part of AIMA's broader program of building rational agents: represent the task clearly, compute with the representation, and evaluate whether the resulting behavior improves expected performance.
...
1. Define **Advanced Linear Algebra** using agent-centered language.
...
1. Build the smallest possible instance of **Advanced Linear Algebra**.
2. Solve it by hand.
...
1. What is the representation used by **Advanced Linear Algebra**?
...
**Previous:** [Section A.2: Linear Algebra Basics](./section-02-linear-algebra-basics.md)  
**Next:** [Section A.4: Probability Fundamentals](./section-04-probability-fundamentals.md)
