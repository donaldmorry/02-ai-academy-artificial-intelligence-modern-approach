# Section 28.3: Neuro-Symbolic AI

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 28.3
> **Previous:** [Section 28.2 - Integration Challenges](./section-02-integration-challenges.md)
> **Next:** [Section 28.4 - World Models](./section-04-world-models.md)
...
**Neuro-Symbolic AI** synthesizes AI techniques toward integrated intelligent systems and research frontiers.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **Neuro-Symbolic AI**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Walk through a toy instance of **Neuro-Symbolic AI** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **neuro-symbolic ai** and measure impact on your chosen metric.
...
Use **Neuro-Symbolic AI** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Neuro-Symbolic AI**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **differentiable reasoning** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **logic neural** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **neuro-symbolic** - see [../../GLOSSARY.md](../../GLOSSARY.md)
...
6. How does neuro-symbolic ai support rational agency?

---

**Previous:** [Section 28.2 - Integration Challenges](./section-02-integration-challenges.md) · **Next:** [Section 28.4 - World Models](./section-04-world-models.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 28.3
