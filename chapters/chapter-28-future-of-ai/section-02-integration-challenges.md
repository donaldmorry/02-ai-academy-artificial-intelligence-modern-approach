# Section 28.2: Integration Challenges

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 28.2
> **Previous:** [Section 28.1 - AI Architectures](./section-01-ai-architectures.md)
> **Next:** [Section 28.3 - Neuro-Symbolic AI](./section-03-neuro-symbolic-ai.md)
...
**Integration Challenges** synthesizes AI techniques toward integrated intelligent systems and research frontiers.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **Integration Challenges**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Walk through a toy instance of **Integration Challenges** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **integration challenges** and measure impact on your chosen metric.
...
Use **Integration Challenges** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Integration Challenges**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **symbol grounding** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **modularity** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **composition** - see [../../GLOSSARY.md](../../GLOSSARY.md)
...
6. How does integration challenges support rational agency?

---

**Previous:** [Section 28.1 - AI Architectures](./section-01-ai-architectures.md) · **Next:** [Section 28.3 - Neuro-Symbolic AI](./section-03-neuro-symbolic-ai.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 28.2
