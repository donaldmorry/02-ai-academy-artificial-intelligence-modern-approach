# Section 28.7: Future Scenarios

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 28.7
> **Previous:** [Section 28.6 - Open Problems](./section-06-open-problems.md)
> **Next:** [Section 28.8 - Capstone Preparation](./section-08-capstone-preparation.md)
...
**Future Scenarios** synthesizes AI techniques toward integrated intelligent systems and research frontiers.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **Future Scenarios**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Walk through a toy instance of **Future Scenarios** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **future scenarios** and measure impact on your chosen metric.
...
Use **Future Scenarios** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **Future Scenarios**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **AGI** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **governance** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **research agenda** - see [../../GLOSSARY.md](../../GLOSSARY.md)
...
6. How does future scenarios support rational agency?

---

**Previous:** [Section 28.6 - Open Problems](./section-06-open-problems.md) · **Next:** [Section 28.8 - Capstone Preparation](./section-08-capstone-preparation.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 28.7
