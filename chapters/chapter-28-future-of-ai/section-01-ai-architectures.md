# Section 28.1: AI Architectures

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 28.1
> **Previous:** [Chapter 27 - Philosophy, Ethics, and Safety](../chapter-27-philosophy-ethics-safety/README.md)
> **Next:** [Section 28.2 - Integration Challenges](./section-02-integration-challenges.md)
> **Prerequisites:** [Chapter 27 - Philosophy & Ethics](../chapter-27-philosophy-ethics-safety/README.md)
...
**AI Architectures** synthesizes AI techniques toward integrated intelligent systems and research frontiers.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **AI Architectures**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Walk through a toy instance of **AI Architectures** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **ai architectures** and measure impact on your chosen metric.
...
Use **AI Architectures** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **AI Architectures**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **cognitive architecture** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **agent components** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **SOAR** - see [../../GLOSSARY.md](../../GLOSSARY.md)
...
6. How does ai architectures support rational agency?

---

**Previous:** [Chapter 27 - Philosophy, Ethics, and Safety](../chapter-27-philosophy-ethics-safety/README.md) · **Next:** [Section 28.2 - Integration Challenges](./section-02-integration-challenges.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 28.1
