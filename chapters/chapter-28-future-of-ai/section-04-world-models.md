# Section 28.4: World Models

> **Source:** Russell & Norvig, *Artificial Intelligence: A Modern Approach* (4th ed.), Chapter 28.4
> **Previous:** [Section 28.3 - Neuro-Symbolic AI](./section-03-neuro-symbolic-ai.md)
> **Next:** [Section 28.5 - Agentic LLMs](./section-05-agentic-llms.md)
...
**World Models** synthesizes AI techniques toward integrated intelligent systems and research frontiers.

---

## Source-Aligned Summary

This section reworks the source chapter into original course notes for **World Models**. The source book supplies the sequence of ideas; this course version turns that sequence into a student-facing workflow: define the task, choose the representation, identify the algorithmic assumptions, and decide how to evaluate the result.
...
Walk through a toy instance of **World Models** by hand: specify inputs, apply the main formula or algorithm, and interpret outputs. Compare with a naive baseline.
...
Extend the Chapter lab with an ablation removing one component of **world models** and measure impact on your chosen metric.
...
Use **World Models** as a complete AIMA-style design exercise rather than a vocabulary item.
...
Write a one-page technical memo for **World Models**. Include the formal model, one algorithm choice, one rejected alternative, two measurable risks, and a test plan. This turns the source chapter from reading material into engineering judgment.

## Key Terms (Glossary)

- **model-based RL** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **prediction** - see [../../GLOSSARY.md](../../GLOSSARY.md)
- **simulation** - see [../../GLOSSARY.md](../../GLOSSARY.md)
...
6. How does world models support rational agency?

---

**Previous:** [Section 28.3 - Neuro-Symbolic AI](./section-03-neuro-symbolic-ai.md) · **Next:** [Section 28.5 - Agentic LLMs](./section-05-agentic-llms.md)

---

## References

1. Russell, S., & Norvig, P. (2020). *Artificial Intelligence: A Modern Approach* (4th ed.). [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) Chapter 28.4
